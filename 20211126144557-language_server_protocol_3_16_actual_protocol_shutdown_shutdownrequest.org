...
Asks the Server to shutdown but not to [[id:f249818a-31e2-4084-8c84-b3a6737d485f][Language Server
Protocol:3.16:Actual Protocol:Server Lifetime:Exit]] (as to allow the
delivering response to the Client).

Clients must not send any notification other than the [[id:eee9d62f-c455-49c6-93f7-9b025deaa93c][Language Server
Protocol:3.16:Actual Protocol:Exit Notification]] after sending this
request.
